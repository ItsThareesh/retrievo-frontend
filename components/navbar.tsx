...
export async function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full border-b border-black/50 shadow-md shadow-grey-400/10 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
