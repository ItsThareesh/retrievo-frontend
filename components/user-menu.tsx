    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="group rounded-full focus:outline-none">
                <Avatar className="h-9 w-9 border-2 border-background ring-2 ring-muted hover:ring-primary active:ring-primary group-data-[state=open]:ring-primary transition-all duration-150 cursor-pointer">
